    ...
    execute: function () {
      ...
      _export("LifeTrackPanel", LifeTrackPanel = (_dec = ccclass('LifeTrackPanel'), _dec2 = property(ScrollView), _dec3 = property({
        ...
        createLifeTrack(age, description) {
          ...
          const item = itemNode.getComponent(_crd && LifeTrackItem === void 0 ? (_reportPossibleCrUseOfLifeTrackItem({
            error: Error()
        ...
        createPropItem(name, value) {
          ...
          const item = itemNode.getComponent(_crd && PropItem === void 0 ? (_reportPossibleCrUseOfPropItem({
            error: Error()
          }), PropItem) : PropItem);
        ...
        initProp() {
          ...
          const property = (_crd && lifeMgr === void 0 ? (_reportPossibleCrUseOflifeMgr({
            error: Error()
        ...
        onShow(selectedTalentList, propData) {
          ...
          const contents = (_crd && lifeMgr === void 0 ? (_reportPossibleCrUseOflifeMgr({
            error: Error()
        ...
        triggerOneLifeTrack() {
          if (!this._isEnd) {
            let track = (_crd && lifeMgr === void 0 ? (_reportPossibleCrUseOflifeMgr({
              error: Error()
