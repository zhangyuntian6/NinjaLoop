      ...
      _export("StartMenuPanel", StartMenuPanel = (_dec = ccclass('StartMenuPanel'), _dec2 = property({
        ...
        createTagCloud(tagList) {
          ...
          for (let i = 0; i < tagLength; i++) {
            ...
            const a = Math.acos(k);
            const b = a * Math.sqrt(tagLength * Math.PI); // var a = Math.random()*2*Math.PI;
            ...
            const tagItem = labelNode.getComponent(_crd && TagItem === void 0 ? (_reportPossibleCrUseOfTagItem({
              error: Error()
            }), TagItem) : TagItem);
