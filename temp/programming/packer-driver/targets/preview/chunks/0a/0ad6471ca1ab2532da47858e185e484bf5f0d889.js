      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property({
        ...
        init() {
          ...
          return _asyncToGenerator(function* () {
            var [, happyLife, specialthanks] = yield Promise.all([(_crd && lifeMgr === void 0 ? (_reportPossibleCrUseOflifeMgr({
              error: Error()
            ...
            (_crd && eventMsg === void 0 ? (_reportPossibleCrUseOfeventMsg({
              ...
              _this.startMenuPanel.show(happyLife);

              _this.selectTalentPanel.hide();

              _this.distributePropPanel.hide();

              _this.lifeTrackPanel.hide();

              _this.loadButtonNode.active = true;
              _this.saveButtonNode.active = true;
              _this.homeButtonNode.active = false;
              _this.githubButtonNode.active = true;
              _this.achievementButtonNode.active = true;
            });
            (_crd && eventMsg === void 0 ? (_reportPossibleCrUseOfeventMsg({
              error: Error()
            }), eventMsg) : eventMsg).on((_crd && Message === void 0 ? (_reportPossibleCrUseOfMessage({
              ...
              _this.startMenuPanel.hide();

              _this.loadButtonNode.active = false;
              _this.saveButtonNode.active = false;
              _this.homeButtonNode.active = true;
              _this.githubButtonNode.active = false;
              _this.achievementButtonNode.active = false;

              _this.openSelectTalentPanel();
            });
            (_crd && eventMsg === void 0 ? (_reportPossibleCrUseOfeventMsg({
              error: Error()
            }), eventMsg) : eventMsg).on((_crd && Message === void 0 ? (_reportPossibleCrUseOfMessage({
              ...
              _this._selectedTalentList = selectedTalentList;

              _this.selectTalentPanel.hide();

              _this.distributePropPanel.show(selectedTalentList);
            });
            (_crd && eventMsg === void 0 ? (_reportPossibleCrUseOfeventMsg({
              error: Error()
            }), eventMsg) : eventMsg).on((_crd && Message === void 0 ? (_reportPossibleCrUseOfMessage({
              ...
              _this.lifeTrackPanel.show(_this._selectedTalentList, propData);
            });
            (_crd && eventMsg === void 0 ? (_reportPossibleCrUseOfeventMsg({
              error: Error()
            }), eventMsg) : eventMsg).on((_crd && Message === void 0 ? (_reportPossibleCrUseOfMessage({
            ...
            (_crd && eventMsg === void 0 ? (_reportPossibleCrUseOfeventMsg({
              ...
              error: Error()
            }), Message) : Message).Achievement, _ref => {
              var {
                name
              } = _ref;

              _this.achievementHint.show(name);
            }); // start
        ...
        openSelectTalentPanel() {
          var talentList = (_crd && lifeMgr === void 0 ? (_reportPossibleCrUseOflifeMgr({
            error: Error()
