  ...
  return {
    ...
    execute: function () {
      ...
      Event = class Event {
        ...
        get(eventId) {
          var event = _classPrivateFieldLooseBase(this, _events)[_events][eventId];
        ...
        do(eventId, property) {
          ...
          if (branch) for (var [cond, next] of branch) if ((_crd && checkCondition === void 0 ? (_reportPossibleCrUseOfcheckCondition({
            error: Error()
