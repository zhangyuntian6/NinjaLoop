  ...
  return {
    ...
    execute: function () {
      ...
      _export("Achievement", Achievement = class Achievement {
        ...
        list(property) {
          return Object.values(_classPrivateFieldLooseBase(this, _achievements)[_achievements]).map(_ref2 => {
            var {
              id,
              name,
              opportunity,
        ...
        get(achievementId) {
          var achievement = _classPrivateFieldLooseBase(this, _achievements)[_achievements][achievementId];
        ...
        isAchieved(achievementId, property) {
          for (var [achieved] of property.get(property.TYPES.ACHV) || []) if (achieved == achievementId) return true;

          return false;
        }

        achieve(opportunity, property) {
          this.list(property).filter(_ref3 => {
            var {
              isAchieved
            } = _ref3;
            return !isAchieved;
