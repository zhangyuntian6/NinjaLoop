      ...
      Property = class Property {
        ...
        initial(_ref) {
          ...
          for (var a in age) {
            ...
            event = event.map(v => {
              var value = ("" + v).split('*').map(n => Number(n));
        ...
        restart(data) {
          ...
          for (var key in data) this.change(key, data[key]);
        }
        ...
        change(prop, value) {
          if (Array.isArray(value)) {
            for (var v of value) this.change(prop, Number(v));
          ...
          switch (prop) {
            ...
            case this.TYPES.TLT:
            case this.TYPES.EVT:
              var _v = _classPrivateFieldLooseBase(this, _data)[_data][prop];
        ...
        effect(effects) {
          for (var prop in effects) this.change(this.hookSpecial(prop), Number(effects[prop]));
        }
